    ...
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent leading-right">
                Hi, I'm Maria Valverde-Cervantes
            </h1>
        ...
        <div className="flex justify-center space-x-4">
            <a
                href="#projects"
                className="transform bg-blue-500 text-white py-3 px-6 rounded font-medium transition 
            ...
            <a
                href="#contact"
                className="transform border border-blue-500/50 text-blue-500 py-3 px-6 rounded font-medium 
